...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('icon.jpg')) # Uygulamanın icon'unu değiştirebiliriz.
        self.setToolTip("my tooltip")
        self.initUI()
    
    def initUI(self):
        self.lbl_name= QtWidgets.QLabel(self) # Oluşturduğumuz nesneyi win'e aktarır
        self.lbl_name.setText("Adiniz: ") # Window'a Text ekler
        self.lbl_name.move(50, 30) # Ekledeğimiz nesneyi kaydırır
    
        self.lbl_surname= QtWidgets.QLabel(self)
        self.lbl_surname.setText("Soyadiniz: ")
        self.lbl_surname.move(50, 70)

        self.txt_name= QtWidgets.QLineEdit(self) #QLineEdit bir text kutucuğu oluşturur
